...
(function initImgModelPicker(){
  const NAME_MAP = {
    ...
    'gemini-3.1-flash-image': { brand: 'G31', desc: 'Gemini 3.1 Flash Image - Google', cost: 25, costType: 'pro' },
    'gemini-3-pro-image': { brand: 'G3', desc: 'Gemini 3 Pro Image - Google', cost: 35, costType: 'pro' },
    'gemini-3.1-flash-image-preview': { brand: 'P31', desc: 'Gemini 3.1 Flash Image Preview', cost: 25, costType: 'pro' },
    'gemini-3-pro-image-preview': { brand: 'P3', desc: 'Gemini 3 Pro Image Preview', cost: 35, costType: 'pro' },
    'imagen-4-fast': { brand: 'IF', desc: 'Imagen 4 Fast - Google', cost: 15, costType: 'pro' },
    'imagen-4': { brand: 'I4', desc: 'Imagen 4 - Google', cost: 25, costType: 'pro' },
    'imagen-4-ultra': { brand: 'IU', desc: 'Imagen 4 Ultra - Google', cost: 40, costType: 'pro' },

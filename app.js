...
function renderModelPicker(filter){
  ...
  catsEl.innerHTML='<div class="mp-cat '+(mpActiveCat==='all'?'active':'')+'" onclick="mpActiveCat=\'all\';renderModelPicker(document.getElementById(\'mp-search\')?.value)">'+figIcon('globe','inline')+' T\u00fcm\u00fc<span class="mp-cat-count">'+totalCount+'</span></div>';

(function(){
  ...
  function isMenuOpen(){
    return !!document.querySelector('.img-model-stable-menu-v461') || document.body.classList.contains('img-model-stable-open-v461');
  }
  ...
  function install(){
    ...
    window.openImageModelPickerTrigger=function(ev){
      ...
      if(isMenuOpen()){closeMenu();return false;}

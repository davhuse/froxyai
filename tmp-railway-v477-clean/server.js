...
const SENTRY_RELEASE = process.env.SENTRY_RELEASE || process.env.RAILWAY_GIT_COMMIT_SHA || 'v477';
...
// v477: stronger acquisition SEO titles/descriptions for organic landing routes.
Object.assign(SEO_PAGES, {
  '/chatgpt-alternatifi': {

...
function hasMojibake(text) {
  ...
  const patterns = [
    ...
    String.fromCharCode(0x00c3, 0x201e),
    String.fromCharCode(0x00c3, 0x2026),
    String.fromCharCode(0x00c3, 0x201a),
    String.fromCharCode(0x00c3, 0x00af, 0x00c2, 0x00bf, 0x00c2, 0x00bd),
...
async function browserChecks(report) {
  ...
  try {
    ...
    await page.waitForSelector('#img-model', { state: 'attached', timeout: 45000 });

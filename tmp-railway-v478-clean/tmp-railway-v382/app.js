...
function imageModelCanGenerate(model){
  ...
  if (m.includes('sdxl') || m.includes('cloudflare') || m.startsWith('cf-')) return true;
...
function imageQualityRecommendedModel(mode){
  ...
  const map=imageWorkflowMode==='edit'?{
    ...
    cheap:['imagegpt-free','flux','pollinations-flux','cloudflare-sdxl','cf-sdxl','auto-quality'],
    fast:['flux','imagegpt-free','pollinations-flux','cloudflare-sdxl','cf-sdxl','auto-quality'],
    quality:['gemini-2.5-flash-image','together-gemini-flash-image','openai-gpt-image-2','imagegpt-free','flux','auto-quality'],
    premium:['openai-gpt-image-2','gemini-3-pro-image','together-gemini-pro-image','flux-kontext-pro','imagegpt-free','flux','auto-quality']
  };

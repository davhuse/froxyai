...
(function initImgModelPicker(){
  ...
  function init(){
    ...
    function imagePickerProviderFamily(model){
      ...
      if(id.includes('pollination')) return 'pollinations';
      if(id.includes('imagegpt')) return 'openai';
...
function socialLogin(provider){
  ...
  const authUrl=origin+'/auth/'+provider+'üreturn_to='+encodeURIComponent(location.origin);
...
async function sendMsg(){
  ...
  if(txt.toLowerCase().startsWith('/image ') || txt.toLowerCase().startsWith('görsel üret ') || txt.toLowerCase().startsWith('çiz ')){
    ...
    try{
      ...
      botMsg.content='\u274c G\u00f6rsel \u00fcretilemedi: '+(normalizeNetworkError?normalizeNetworkError(e):(e.message||'Sa\u011flay\u0131c\u0131 ger?ek ??kt? d?nd?rmedi.'));
      saveChats();renderMsgs();
...
(function(){
  ...
  const data={
    ...
    gemini:['Gemini / Nano Banana','#8b5cf6',['Referans anlama','Hızlı varyasyon','Karakter tutarlılığı','Foto edit'],'Referans fotoğraf? anlayıp iterasyon üretmekte iyi; düzenleme modunda tercih edilecek modellerden.',['/assets/model-showcase/showcase-gemini-1.png','/assets/model-showcase/showcase-gemini-2.png'],['Ayn? karakteri sinematik neon portreye dönüştür, gerçekçi ışık','Minimal teknoloji Ürün? için parlak sosyal medya görseli']],
    flux:['FLUX / Kontext','#ec4899',['Gerçekçi sahne','Moda/portre','Poster','Konsept art'],'Yaratıcı kompozisyon, atmosfer ve gerçekçi sahnelerde güçlü; premium i?lerde tercih edilebilir.',['/assets/model-showcase/showcase-flux-1.jpg','/assets/model-showcase/showcase-flux-2.jpg'],['Doğal ışıkl? profesyonel portre, editoryal dergi kapağı hissi','Bilim kurgu Ürün lansman sahnesi, premium atmosfer']],
    cloudflare:['Cloudflare SDXL','#f59e0b',['Ucuz taslak','Hızlı deneme','Stil arama','Basit görsel'],'Dışık maliyetli hızlı taslak hatt?. Premium i?e geçmeden önce fikir denemek için ideal.',['/assets/model-showcase/showcase-cloudflare-1.png','/assets/model-showcase/showcase-cloudflare-2.png'],['Temiz arka planda hızlı Ürün taslağı, yumuşak ışık','Logo fikri için sade moodboard, modern renk paleti']],
    pollinations:['Pollinations','#22c55e',['Ücretsiz deneme','Hızlı fikir','Basit sahne'],'Ücretsiz ve hızlı deneme için uygun. Ticari son görsel için premium modellerle tekrar üretmek daha iyi olur.',['/assets/model-showcase/showcase-cloudflare-1.png','/assets/model-showcase/showcase-flux-1.jpg'],['Sosyal medya post fikri, net kompozisyon, parlak renkler','K?sa kampanya için mood görseli, sade arka plan']],
...
(function(){
  ...
  function fam(model){const m=String(model||'').toLowerCase(); if(/gpt|openai|dall/.test(m))return 'openai'; if(/gemini|nano|imagen/.test(m))return 'gemini'; if(/flux|kontext/.test(m))return 'flux'; if(/cloudflare|sdxl|cf-/.test(m))return 'cloudflare'; if(/pollinations/.test(m))return 'pollinations'; if(/imagegpt/.test(m))return 'imagegpt'; if(/qwen/.test(m))return 'qwen'; return 'generic';}
  const logos={openai:'/provider-logos/openai.svg',gemini:'/provider-logos/gemini.svg',flux:'/provider-logos/together.svg',cloudflare:'/provider-logos/cloudflare.svg',pollinations:'/provider-logos/pollinations.svg',imagegpt:'/provider-logos/openai.svg',qwen:'/provider-logos/qwen.svg',generic:'/provider-logos/generic.svg'};
  const rows={
    openai:['OpenAI / GPT Image','#22d3ee',['Metin uyumu','Foto&#287;raf d&#252;zenleme','&#220;r&#252;n g&#246;rseli','Afi&#351;'],'Prompta sad&#305;k, kompozisyon kontrol&#252; g&#252;&#231;l&#252; ve edit i&#351;lerinde en g&#252;venli hat.',['/assets/model-showcase/showcase-openai-1.png','/assets/model-showcase/showcase-openai-2.png'],['Premium st&#252;dyo &#305;&#351;&#305;&#287;&#305;nda cam parf&#252;m &#351;i&#351;esi, siyah zemin, yumu&#351;ak yans&#305;ma','Modern SaaS reklam posteri, k&#305;sa ba&#351;l&#305;k alan&#305;, temiz &#252;r&#252;n mockup']],
    gemini:['Gemini / Nano Banana','#8b5cf6',['Referans anlama','H&#305;zl&#305; varyasyon','Karakter tutarl&#305;l&#305;&#287;&#305;','Foto edit'],'Referans foto&#287;raf&#305; anlay&#305;p iterasyon &#252;retmekte iyi; d&#252;zenleme modunda tercih edilecek modellerden.',['/assets/model-showcase/showcase-gemini-1.png','/assets/model-showcase/showcase-gemini-2.png'],['Ayn&#305; karakteri sinematik neon portreye d&#246;n&#252;&#351;t&#252;r, ger&#231;ek&#231;i &#305;&#351;&#305;k','Minimal teknoloji &#252;r&#252;n&#252; i&#231;in parlak sosyal medya g&#246;rseli']],
